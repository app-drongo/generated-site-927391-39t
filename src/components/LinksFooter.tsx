// Enhanced by AI on 2025-08-14T15:05:01.098Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Discover the latest insights and trends in the world of tech and startups. 
                Our blog features thought-provoking articles from industry experts and innovators.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@blog.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest blog updates and exclusive content. Unsubscribe anytime.
              </p>
            </div>
          </div>
